...
### JAMES THIS IS WHERE YOU NEED TO FIX
    ...
    Index_to_delete = df_hotels_on_secondary_market_list.index(token_id_listed)
    df_hotels_on_secondary_market_list = df_hotels_on_secondary_market_list[Index_to_delete].remove()
